...
def get_parse():
    ...
    parser.add_argument('--data_dir',default='/media/dmmm/CE31-3598/DataSets/DenseCV_Data/高度数据集/newdata/train/',type=str, help='training dir path')
    ...
    parser.add_argument('--rotate', default=0, type=int, help='rotate in transform')
    ...
    parser.add_argument('--LPN',  default=1, type=int, help='')
    ...
    parser.add_argument('--deit',default=1,type=int,help='')
