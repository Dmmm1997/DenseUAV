...
parser.add_argument('--test_dir',default='/media/dmmm/CE31-3598/DataSets/DenseCV_Data/improvedOriData/test',type=str, help='./test_data')
parser.add_argument('--config',
                    default="/media/dmmm/CE31-3598/DataSets/DenseCV_Data/improvedOriData/Dense_GPS_train.txt", type=str,
                    help='./test_data')
